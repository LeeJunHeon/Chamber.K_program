...
"}")
        ...
        #   컬럼 폭 271(x 735~1006)을 칸 사이 9px 로 3등분: 84 + 9 + 84 + 9 + 85.
        #     열1 RF power : x=735 w=84  (735~818)
        #     열2 RF Pulse : x=828 w=84  (828~911)
        #     열3 DC power : x=921 w=85  (921~1005)
        #   setTabOrder 는 쓰지 않는다 — 생성 순서가 탭 순서다(RF_power_edit → rfp_power_edit → DC_power_edit).
        ...
        # 폭은 sizeHint 94 — 85 로 두면 "DC powe" 로 잘린다(실측). 우측 1014 는 heater_group(1022) 앞 빈 공간.
        self.dc_power_checkbox.setGeometry(QRect(921, 245, 94, 20))

        self.RF_power_edit = QPlainTextEdit(Dialog)
        self.RF_power_edit.setObjectName(u"RF_power_edit")
        self.RF_power_edit.setGeometry(QRect(735, 265, 84, 31))
        ...
        self.DC_power_edit.setGeometry(QRect(921, 265, 85, 31))
        self.DC_power_edit.setPlainText("200")

        # --- DC Power 안정화 대기 사용 여부 (기본 OFF) — 오른쪽 끝 1006 정렬, DC 칸 아래 ---
        ...
        self.rfp_ref_p_label.setGeometry(QRect(945, 520, 60, 20))
        ...
        self.rfp_ref_p_edit.setGeometry(QRect(945, 542, 60, 31))
        ...
        self.Sputter_Start_Button.setGeometry(QRect(735, 590, 130, 60))
...
"QPushButton:pressed {background: #808080; border-color: #333333;}")
        ...
        self.Sputter_Stop_Button.setGeometry(QRect(875, 590, 130, 60))
...
"QPushButton:pressed {background: #808080; border-color: #333333;}")
        ...
        self.heater_group.setGeometry(QRect(1022, 20, 220, 469))
        ...
        self.heater_title_label.setGeometry(QRect(10, 6, 120, 20))
        ...
        # ============ PZ400 스타일 LCD 표시부 ============
        #  이상이 나면 main.py 가 QFrame#heater_lcd 선택자로 테두리 색만 바꾼다.
        self.heater_lcd = QFrame(self.heater_group)
        self.heater_lcd.setObjectName(u"heater_lcd")
        self.heater_lcd.setGeometry(QRect(10, 32, 200, 156))
        self.heater_lcd.setFrameShape(QFrame.Shape.NoFrame)
        self.heater_lcd.setStyleSheet(
            u"QFrame#heater_lcd {background: #f7f8fa; "
            u"border: 1px solid #dfe3e8; border-radius: 6px;}"
        )

        # --- PV (현재 온도) ---
        self.heater_pv_title = QLabel(self.heater_lcd)
        ...
        self.heater_sv_small = QLabel(self.heater_lcd)
        self.heater_sv_small.setObjectName(u"heater_sv_small")
        ...
        self.heater_sv_big.setObjectName(u"heater_sv_big")
        self.heater_sv_big.setGeometry(QRect(30, 50, 100, 30))
        self.heater_sv_big.setAlignment(Qt.AlignmentFlag.AlignRight
                                        | Qt.AlignmentFlag.AlignVCenter)
        self.heater_sv_big.setStyleSheet(
            u"QLabel {border: none; background: transparent; "
            u"color: #6b7280; font-size: 17pt; font-weight: bold;}"
        )

        self.heater_dev_label = QLabel(self.heater_lcd)
        self.heater_dev_label.setObjectName(u"heater_dev_label")
        self.heater_dev_label.setGeometry(QRect(134, 56, 58, 20))
        self.heater_dev_label.setAlignment(Qt.AlignmentFlag.AlignRight
                                           | Qt.AlignmentFlag.AlignVCenter)
        ...
        # --- 구분선 ---
        self.heater_lcd_sep = QFrame(self.heater_lcd)
        self.heater_lcd_sep.setObjectName(u"heater_lcd_sep")
        self.heater_lcd_sep.setGeometry(QRect(8, 86, 184, 1))
        self.heater_lcd_sep.setFrameShape(QFrame.Shape.NoFrame)
        self.heater_lcd_sep.setStyleSheet(u"background: #e5e7eb; border: none;")
        ...
        self.heater_seg_label.setStyleSheet(
            u"QLabel {border: none; background: transparent; "
            u"color: #546e7a; font-size: 9pt; "
            u"font-family: 'Malgun Gothic','\ub9d1\uc740 \uace0\ub515','Noto Sans KR',sans-serif;}"
        )
        ...
        self.heater_time_label.setStyleSheet(
            u"QLabel {border: none; background: transparent; color: #37474f; "
            u"font-size: 10pt; font-family: 'Consolas','Courier New',monospace;}"
        )

        # --- 운전 배지 + 출력 바 ---
        self.heater_run_badge = QLabel(self.heater_lcd)
        self.heater_run_badge.setObjectName(u"heater_run_badge")
        self.heater_run_badge.setGeometry(QRect(8, 116, 46, 18))
        ...
        # --- 남은 시간 (전체 %는 위 바에 들어간다) ---
        self.heater_prog_label = QLabel(self.heater_lcd)
        self.heater_prog_label.setObjectName(u"heater_prog_label")
        self.heater_prog_label.setGeometry(QRect(8, 136, 184, 16))
        self.heater_prog_label.setAlignment(
            Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)
        self.heater_prog_label.setStyleSheet(
            u"QLabel {border: none; background: transparent; color: #607d8b; font-size: 8.5pt;}"
        )

        # --- 가스·압력 (히터 전용 분위기 제어) ---
        #  Ar/O2 를 하나라도 고르면 히터를 켜기 전에 가스를 넣고 압력을 잡는다.
        #  히터가 꺼지면 main.py 가 자동으로 해제한다.
        #  목표 온도 줄과 같은 열에 맞춘다(라벨 10 · 입력 50 · 단위 114).
        self.heater_ar_check = QCheckBox(self.heater_group)
        self.heater_ar_check.setObjectName(u"heater_ar_check")
        self.heater_ar_check.setGeometry(QRect(8, 196, 42, 24))
        self.heater_ar_check.setStyleSheet(
            u"QCheckBox {border: none; color: #333333;}"
        )

        self.heater_ar_flow_edit = QLineEdit(self.heater_group)
        self.heater_ar_flow_edit.setObjectName(u"heater_ar_flow_edit")
        self.heater_ar_flow_edit.setGeometry(QRect(50, 196, 60, 24))
        self.heater_ar_flow_edit.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.heater_ar_flow_edit.setMaxLength(6)
        self.heater_ar_flow_edit.setStyleSheet(
            ...
            u"QLineEdit:disabled {background: #f3f3f3; color: #9e9e9e; border: 1px solid #e0e0e0;}"
        )

        self.heater_ar_unit = QLabel(self.heater_group)
        self.heater_ar_unit.setObjectName(u"heater_ar_unit")
        self.heater_ar_unit.setGeometry(QRect(114, 196, 40, 24))
        self.heater_ar_unit.setStyleSheet(
            u"QLabel {border: none; color: #666666; font-size: 8.5pt;}"
        )

        self.heater_o2_check = QCheckBox(self.heater_group)
        self.heater_o2_check.setObjectName(u"heater_o2_check")
        self.heater_o2_check.setGeometry(QRect(8, 224, 42, 24))
        self.heater_o2_check.setStyleSheet(
            u"QCheckBox {border: none; color: #333333;}"
        )

        self.heater_o2_flow_edit = QLineEdit(self.heater_group)
        self.heater_o2_flow_edit.setObjectName(u"heater_o2_flow_edit")
        self.heater_o2_flow_edit.setGeometry(QRect(50, 224, 60, 24))
        self.heater_o2_flow_edit.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.heater_o2_flow_edit.setMaxLength(6)
        self.heater_o2_flow_edit.setStyleSheet(
            u"QLineEdit {background: #ffffff; border: 1px solid #cccccc; "
            u"border-radius: 3px; color: #333333;}"
            u"QLineEdit:focus {border: 1px solid #4a90d9;}"
            u"QLineEdit:disabled {background: #f3f3f3; color: #9e9e9e; border: 1px solid #e0e0e0;}"
        ...
        self.heater_o2_unit = QLabel(self.heater_group)
        self.heater_o2_unit.setObjectName(u"heater_o2_unit")
        self.heater_o2_unit.setGeometry(QRect(114, 224, 40, 24))
        self.heater_o2_unit.setStyleSheet(
            u"QLabel {border: none; color: #666666; font-size: 8.5pt;}"
        )

        self.heater_wp_title = QLabel(self.heater_group)
        self.heater_wp_title.setObjectName(u"heater_wp_title")
        self.heater_wp_title.setGeometry(QRect(10, 252, 36, 24))
        self.heater_wp_title.setStyleSheet(u"QLabel {border: none; color: #333333;}")

        self.heater_wp_edit = QLineEdit(self.heater_group)
        self.heater_wp_edit.setObjectName(u"heater_wp_edit")
        self.heater_wp_edit.setGeometry(QRect(50, 252, 60, 24))
        self.heater_wp_edit.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.heater_wp_edit.setMaxLength(6)
        self.heater_wp_edit.setStyleSheet(
            u"QLineEdit {background: #ffffff; border: 1px solid #cccccc; "
            u"border-radius: 3px; color: #333333;}"
            u"QLineEdit:focus {border: 1px solid #4a90d9;}"
            u"QLineEdit:disabled {background: #f3f3f3; color: #9e9e9e; border: 1px solid #e0e0e0;}"
        ...
        self.heater_wp_unit = QLabel(self.heater_group)
        self.heater_wp_unit.setObjectName(u"heater_wp_unit")
        self.heater_wp_unit.setGeometry(QRect(114, 252, 60, 24))
        self.heater_wp_unit.setStyleSheet(
            u"QLabel {border: none; color: #666666; font-size: 8.5pt;}"
        )

        # --- 수동 조작: 목표 온도 입력 + 적용 + ON ---
        self.heater_sv_title = QLabel(self.heater_group)
        self.heater_sv_title.setObjectName(u"heater_sv_title")
        self.heater_sv_title.setGeometry(QRect(10, 284, 36, 26))
        ...
        self.heater_sv_edit.setGeometry(QRect(50, 284, 60, 26))
        ...
        self.heater_apply_button.setGeometry(QRect(116, 284, 42, 26))
        ...
        self.heater_onoff_button.setGeometry(QRect(164, 284, 46, 26))
        ...
        self.heater_onoff_button.setStyleSheet(
            ...
            u"QPushButton:checked {background: #2e7d32; color: white; "
            u"font-weight: bold; border-radius: 4px; border: 1px solid #1b5e20;}"
        )
        ...
        self.heater_status_label.setGeometry(QRect(10, 318, 138, 20))
        ...
        self.heater_out_bar.setGeometry(QRect(10, 340, 200, 20))
        ...
        self.heater_hold_button.setGeometry(QRect(10, 368, 70, 28))
        ...
        self.heater_skip_button.setGeometry(QRect(84, 368, 70, 28))
        ...
        self.heater_stop_button.setGeometry(QRect(158, 368, 52, 28))
        ...
        # --- 스텝 목록 (현재 스텝을 main.py 가 강조한다) ---
        self.heater_step_list = QListWidget(self.heater_group)
        self.heater_step_list.setObjectName(u"heater_step_list")
        self.heater_step_list.setGeometry(QRect(10, 404, 200, 55))
        self.heater_step_list.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        self.heater_step_list.setSelectionMode(
            QAbstractItemView.SelectionMode.NoSelection)
        self.heater_step_list.setVerticalScrollBarPolicy(
            Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self.heater_step_list.setHorizontalScrollBarPolicy(
            Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.heater_step_list.setStyleSheet(
            u"QListWidget {background: #ffffff; border: 1px solid #dfe3e8; "
            u"border-radius: 4px; font-size: 8.5pt; color: #333333; "
            u"font-family: 'Malgun Gothic','\ub9d1\uc740 \uace0\ub515','Noto Sans KR',sans-serif;}"
            u"QListWidget::item {padding: 1px;}"
        )
        # ===================== 히터 =====================
        ...
        self.ION_group.setGeometry(QRect(1022, 499, 220, 160))
...
"QPushButton:checked {background: #32FF32; color: black; font-weight: bold; font-size: 18pt; border-radius: 8px; border: 2px solid #229b12;}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.heater_o2_check.setText(QCoreApplication.translate("Dialog", u"O2", None))
        self.heater_wp_title.setText(QCoreApplication.translate("Dialog", u"\uc555\ub825", None))
        ...
        self.heater_sv_big.setText(QCoreApplication.translate("Dialog", u"---", None))
        self.heater_dev_label.setText("")
        self.heater_seg_label.setText(QCoreApplication.translate("Dialog", u"\ub808\uc2dc\ud53c \uc5c6\uc74c", None))
        self.heater_time_label.setText(QCoreApplication.translate("Dialog", u"--:--:--", None))
        self.heater_run_badge.setText(QCoreApplication.translate("Dialog", u"STOP", None))
        self.heater_prog_label.setText("")
        ...
        self.heater_hold_button.setToolTip(QCoreApplication.translate("Dialog",
            u"레시피를 현재 지점에서 일시정지합니다. RAMP 중이면 그 온도를 유지하고,\n"
        ...
        self.heater_o2_flow_edit.setToolTip(QCoreApplication.translate("Dialog",
            u"O2 유량 [sccm]", None))
        self.heater_wp_edit.setToolTip(QCoreApplication.translate("Dialog",
            u"목표 공정 압력 [mTorr]", None))
        ...
        self.heater_step_list.setToolTip(QCoreApplication.translate("Dialog",
            u"불러온 레시피의 스텝 목록. 현재 스텝이 강조된다", None))
